...
class intelRealSenseSubscriberNode(Node):
    def __init__(self) -> None:
        ...
        self.intel_pubber = self.create_publisher(Image, '/out/image', queue_size=3)
    ...
    def ImageProcessor(self, imCV):
        faceCascade = cv2.CascadeClassifier('./perception_navigation/perception_navigation/haarcascade_frontalface_default.xml')
        ...
        self.intel_subber.publish(imCV)
